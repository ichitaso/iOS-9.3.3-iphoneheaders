...
@property (assign) BOOL cacheRefreshInProgress;                                      //@synthesize cacheRefreshInProgress=_cacheRefreshInProgress - In the implementation block
...
-(BOOL)handleRecentlySeenEvent:(id)arg1 forConnection:(id)arg2 tag:(unsigned)arg3 ;
-(BOOL)handleImportEvent:(id)arg1 forConnection:(id)arg2 tag:(unsigned)arg3 ;
-(id)objectWithError:(id)arg1 ;
-(void)relocateCachingServerWithTimeout:(double)arg1 capabilities:(id)arg2 affinityID:(id)arg3 forceRefresh:(BOOL)arg4 tag:(unsigned)arg5 ;
-(void)locateCachingServerWithTimeout:(double)arg1 capabilities:(id)arg2 affinityID:(id)arg3 quickMiss:(BOOL)arg4 callback:(/*^block*/id)arg5 callbackQueue:(id)arg6 tag:(unsigned)arg7 ;
-(void)recentlySeenCachingServerWithCallback:(/*^block*/id)arg1 callbackQueue:(id)arg2 tag:(unsigned)arg3 ;
-(void)importToCachingServerAsURL:(id)arg1 sourcePath:(id)arg2 sourceFileHandle:(id)arg3 sourceOffset:(long long)arg4 sourceLength:(long long)arg5 headers:(id)arg6 importStrategies:(id)arg7 entitled:(BOOL)arg8 callback:(/*^block*/id)arg9 callbackQueue:(id)arg10 tag:(unsigned)arg11 ;
...
-(void)cacheRecentlySeen:(BOOL)arg1 forNetworkIdentifiers:(id)arg2 validityInterval:(double)arg3 tag:(unsigned)arg4 ;
-(id)locateCallback;
...
-(BOOL)doesServer:(id)arg1 haveCapabilities:(id)arg2 tag:(unsigned)arg3 ;
...
-(void)slowcateCachingServerWithTimeout:(double)arg1 capabilities:(id)arg2 affinityID:(id)arg3 forceRefresh:(BOOL)arg4 callback:(/*^block*/id)arg5 tag:(unsigned)arg6 ;
-(BOOL)cacheRefreshInProgress;
-(void)setCacheRefreshInProgress:(BOOL)arg1 ;
